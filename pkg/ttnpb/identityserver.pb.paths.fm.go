...
var AuthInfoResponseFieldPathsNested = []string{
	...
	"access_method.api_key.entity_ids.ids.cluster_ids",
	"access_method.api_key.entity_ids.ids.cluster_ids.cluster_id",
...
var AuthInfoResponse_APIKeyAccessFieldPathsNested = []string{
	...
	"entity_ids.ids.cluster_ids",
	"entity_ids.ids.cluster_ids.cluster_id",
