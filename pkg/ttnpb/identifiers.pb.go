...
func (m *ClusterIdentifiers) Reset()      { *m = ClusterIdentifiers{} }
func (*ClusterIdentifiers) ProtoMessage() {}
func (*ClusterIdentifiers) Descriptor() ([]byte, []int) {
	return fileDescriptor_6da1fbfdea4d7423, []int{2}
}
func (m *ClusterIdentifiers) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *ClusterIdentifiers) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_ClusterIdentifiers.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalTo(b)
		if err != nil {
...
func (m *ClusterIdentifiers) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ClusterIdentifiers.Merge(m, src)
}
func (m *ClusterIdentifiers) XXX_Size() int {
	return m.Size()
}
func (m *ClusterIdentifiers) XXX_DiscardUnknown() {
	xxx_messageInfo_ClusterIdentifiers.DiscardUnknown(m)
}

var xxx_messageInfo_ClusterIdentifiers proto.InternalMessageInfo

func (m *ClusterIdentifiers) GetClusterID() string {
	if m != nil {
		return m.ClusterID
	}
	return ""
...
type EntityIdentifiers_ClusterIDs struct {
	ClusterIDs *ClusterIdentifiers `protobuf:"bytes,7,opt,name=cluster_ids,json=clusterIds,proto3,oneof"`
}
...
func (*EntityIdentifiers_ClusterIDs) isEntityIdentifiers_Ids()      {}
...
func (m *EntityIdentifiers) GetClusterIDs() *ClusterIdentifiers {
	if x, ok := m.GetIds().(*EntityIdentifiers_ClusterIDs); ok {
		return x.ClusterIDs
	}
	return nil
}
...
func (*EntityIdentifiers) XXX_OneofFuncs() (func(msg proto.Message, b *proto.Buffer) error, func(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error), func(msg proto.Message) (n int), []interface{}) {
	return _EntityIdentifiers_OneofMarshaler, _EntityIdentifiers_OneofUnmarshaler, _EntityIdentifiers_OneofSizer, []interface{}{
		...
		(*EntityIdentifiers_ClusterIDs)(nil),
	}
}
...
func _EntityIdentifiers_OneofMarshaler(msg proto.Message, b *proto.Buffer) error {
	...
	case *EntityIdentifiers_ClusterIDs:
		...
		if err := b.EncodeMessage(x.ClusterIDs); err != nil {
			return err
		}
	case nil:
	default:
...
func _EntityIdentifiers_OneofUnmarshaler(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error) {
	...
	case 6: // ids.user_ids
		...
		return true, err
	case 7: // ids.cluster_ids
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(ClusterIdentifiers)
		err := b.DecodeMessage(msg)
		m.Ids = &EntityIdentifiers_ClusterIDs{msg}
		return true, err
	default:
		return false, nil
	}
...
func init() {
	...
	proto.RegisterType((*ClusterIdentifiers)(nil), "ttn.lorawan.v3.ClusterIdentifiers")
	golang_proto.RegisterType((*ClusterIdentifiers)(nil), "ttn.lorawan.v3.ClusterIdentifiers")
...
var fileDescriptor_6da1fbfdea4d7423 = []byte{
	...
	,
}
...
func (this *ClusterIdentifiers) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*ClusterIdentifiers)
	if !ok {
		that2, ok := that.(ClusterIdentifiers)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *EntityIdentifiers_ClusterIDs) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*EntityIdentifiers_ClusterIDs)
	if !ok {
		that2, ok := that.(EntityIdentifiers_ClusterIDs)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (m *ClusterIdentifiers) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *ClusterIdentifiers) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (m *EntityIdentifiers_ClusterIDs) MarshalTo(dAtA []byte) (int, error) {
	i := 0
	if m.ClusterIDs != nil {
		dAtA[i] = 0x3a
		i++
		i = encodeVarintIdentifiers(dAtA, i, uint64(m.ClusterIDs.Size()))
		n16, err := m.ClusterIDs.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n16
...
func NewPopulatedEntityIdentifiers(r randyIdentifiers, easy bool) *EntityIdentifiers {
	...
	oneofNumber_Ids := []int32{1, 2, 3, 4, 5, 6, 7}[r.Intn(7)]
	switch oneofNumber_Ids {
	case 1:
	...
	case 7:
		this.Ids = NewPopulatedEntityIdentifiers_ClusterIDs(r, easy)
	}
	if !easy && r.Intn(10) != 0 {
	}
	return this
...
func NewPopulatedEntityIdentifiers_ClusterIDs(r randyIdentifiers, easy bool) *EntityIdentifiers_ClusterIDs {
	this := &EntityIdentifiers_ClusterIDs{}
	this.ClusterIDs = NewPopulatedClusterIdentifiers(r, easy)
	return this
}
...
func (m *ClusterIdentifiers) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *EntityIdentifiers_ClusterIDs) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (this *ClusterIdentifiers) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&ClusterIdentifiers{`,
...
func (this *EntityIdentifiers_ClusterIDs) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&EntityIdentifiers_ClusterIDs{`,
		`ClusterIDs:` + strings.Replace(fmt.Sprintf("%v", this.ClusterIDs), "ClusterIdentifiers", "ClusterIdentifiers", 1) + `,`,
		`}`,
	}, "")
	return s
}
...
func (m *ClusterIdentifiers) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ClusterIdentifiers: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ClusterIdentifiers: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *EntityIdentifiers) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 7:
			...
			v := &ClusterIdentifiers{}
			if err := v.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			m.Ids = &EntityIdentifiers_ClusterIDs{v}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipIdentifiers(dAtA[iNdEx:])
